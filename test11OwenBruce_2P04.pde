...
PLOTS            { save result displays }
  grid(x+u,y+v,z+w)
  grid(x+u*100000, y+v*100000,z+w*100000)
  ...
  contour(ex) painted on x=Lx/2
  
  elevation(ex,ez,gyz,gxz,gxy) from (0,Ly/2,Lz/2) to (Lx,Ly/2,Lz/2)
  elevation(ex,ez,gyz,gxz,gxy) from (Lx/2,0,Lz/2) to (Lx/2,Ly,Lz/2)
  elevation(ex,ez,gyz,gxz,gxy) from (Lx/2,Ly/2,0) to (Lx/2,Ly/2,Lz)
